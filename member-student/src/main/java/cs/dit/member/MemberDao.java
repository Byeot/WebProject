...
public class MemberDao {
	...
	private Connection getConnection() throws Exception{
		...
		DataSource ds = (DataSource) envCtx.lookup("jdbc/jihyeon");//3. 자원들 중 원하는 jdbc/jihyeon 자원을 찾아내어 데이터소스를 가져옴
	...
	public ArrayList<MemberDto> list(int page,int numOfRecords){ //Db에서 게시글 정보 조회
	...
	public int recordCount() {//전체 레코드수 파악하기
		int count = 0;
