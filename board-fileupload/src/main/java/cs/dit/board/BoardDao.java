...
public class BoardDao {
	...
	*======================================================================*/
	...
	private Connection getConnection() throws Exception{
		...
		DataSource ds = (DataSource) envCtx.lookup("jdbc/jihyeon");//3. 자원들 중 원하는 jdbc/jskim 자원을 찾아내어 데이터소스를 가져옴
	...
	public BoardDto selectOne(int bcode) {
		System.out.println("select one start");
		...
		System.out.println("select one end");
		return dto;
	}
